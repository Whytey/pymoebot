...
|------|------------|---------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| 6    | r/w        | 0-100                                                                                             | 'Battery'                                                                               |
| 101  | r/?        | STANDBY MOWING/CHARGING/EMERGENCY/LOCKED/<br/>PAUSED/PARK/CHARGING_WITH_TASK_SUSPEND/FIXED_MOWING | 'Machine Status' Provides state - can't seem to command state using this                |
| 102  | ??         | 0                                                                                                 | 'Machine error'                                                                         |
| 103  | r/?        | MOWER_LEAN/MOWER_EMERGENCY/MOWER_UI_LOCKED/                                                       | 'Machine warning' Provides sub-states for when the mower is in EMERGENCY                |
...
| 115  | w          | StartMowing/StartFixedMowing/PauseWork/CancelWork/StartReturnStation                              | 'Machine Control CMD' used to change mower state                                        |
